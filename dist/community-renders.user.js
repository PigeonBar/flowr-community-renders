...
(function () {
  ...
  const renderDataScales = {
    Beetle: 350,
    "Desert Moth": 110
  };
  const renderDataRotations = {
    Beetle: Math.PI / 2
  };
  ...
  function communityRender(enemy, type) {
  ...
  function addCommunityRenders(types) {
    for (let type of types) {
      enemyRenderMap[type] = function(enemy) {
