...
/**
 * The data structure for the rendering data for each individual path.
 */
export type PathData = {
  /**
   * The SVG path data for this path.
   */
  d: string,

  /**
   * The path's base fill colour before shaders (e.g., damage flash).
   */
  baseFill: string,

  /**
   * The path's base stroke colour before shaders (e.g., damage flash).
   */
  baseStroke: string,
...
/**
 * The data structure for the rendering data for a mob component.
 */
export type ComponentData = {
  /**
   * A list of data for the paths for this component.
   */
  paths: PathData[],
...
export type RenderData = {
  /**
   * A list of render data for all of the mob's components.
   */
  ...
  /**
   * Whether or not to use caching for this render.
   */
  useCaching?: boolean,
}
 ...
 */
export const renderData: Partial<Record<EnemyType, MobData>> = {
  Beetle: {
    Guest: {
...
/**
 * This initializer activates cached renders by adding copies of all stored
 * render data and setting `useCaching` to `true` for these copies.
 */
function addCachedRenderOptions(): void {
  for (let mobData of Object.values(renderData)) {
    if (!isNil(mobData)){
      for (let [ artist, renderData ] of Object.entries(mobData)) {
        if (artist !== "Base game") {
          mobData[artist + " (cached)" as ArtistName] = {
            ...renderData,
            useCaching: true,
          };
        }
  ...
  // Also handle freezing the data here
...
export function getAvailableArtists(enemyType: EnemyType): ArtistName[] {
  // Before retrieving list of artists, check whether cached render options
  // need to be added.
